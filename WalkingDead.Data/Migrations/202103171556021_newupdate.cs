namespace WalkingDead.Data.Migrations
{
    ...
    public partial class newupdate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        SeasonId = c.Int(nullable: false),
                        StartingLocationId = c.Int(nullable: false),
                        AddedByUserId = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.SeasonId)
                .ForeignKey("dbo.Location", t => t.StartingLocationId, cascadeDelete: false)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Season", "StartingLocationId", "dbo.Location");
            DropForeignKey("dbo.Episode", "LocationId", "dbo.Location");
